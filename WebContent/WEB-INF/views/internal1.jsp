...
<%@ page import="java.util.* , beans.Internal1" %>
...
<html>
 ...
 <body>
   ...
   <form method="POST" action="doInternal1">
            <select name="Dept">
   ...
   <table border="1" cellpadding="5" cellspacing="1" >
     ...
     <%
       List<Internal1> list = (List<Internal1>)     request.getAttribute("Internal1");
       
     
       for(Internal1 cycle2: list){
